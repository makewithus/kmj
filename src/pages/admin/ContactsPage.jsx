...
const ContactsPage = () => {
  ...
  const fetchContacts = useCallback(async () => {
    try {
      ...
      toast.error(getErrorMessage(error, "Failed to fetch contacts"));
    } finally {
      setLoading(false);
    }
  }, [searchQuery]);
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600 mt-2 text-sm">
              Manage contact information with warranty files • Total:{" "}
                  ...
                  <tbody className="bg-white divide-y divide-gray-100">
                    {filteredContacts.map((contact) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          {contact.warrantyFiles?.filter((f) => f).length >
                          0 ? (
                            <button
                              onClick={() =>
                                setPreviewFile(contact.warrantyFiles)
                              }
                              ...
                              >
                                ...
                                <FileUpload
                                  ...
                                  onUploadComplete={(url) =>
                                    handleFileUploadComplete(index, url)
                                  }
                ...
                >
                  <div className="p-4 border-b border-gray-200 flex items-center justify-between">
                    <h3 className="text-lg font-bold text-gray-900">
                      Warranty Files (
                      {Array.isArray(previewFile)
                        ? previewFile.filter((f) => f).length
                        : 0}
                      )
                    </h3>
                    <button
