...
const NoticesPage = () => {
  ...
  const fetchNotices = useCallback(async () => {
    try {
      ...
      if (
        error?.isQuotaBlocked ||
        error?.name === "QuotaBlockedError" ||
      ...
      toast.error(getErrorMessage(error, "Failed to fetch notices"));
    } finally {
      setLoading(false);
    }
  }, []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(getErrorMessage(error, "Failed to save notice"));
    }
  };
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-2 text-lg">
                Manage and broadcast important notices to members
              </p>
            </div>
            <Button
              variant="primary"
                    ...
                    <form onSubmit={handleSubmit} className="p-8 space-y-6">
                      ...
                      <div className="pt-16">
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                          Notice will automatically expire after this date
                        </p>
                      </div>
