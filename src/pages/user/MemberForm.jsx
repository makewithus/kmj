    ...
    <AdminLayout>
      ...
      >
        <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
          <Button
            variant="ghost"
            size="sm"
            leftIcon={<ArrowLeftIcon className="h-3.5 w-3.5 sm:h-4 sm:w-4" />}
      ...
      {!isEdit && (
        ...
        >
          <Card className="bg-linear-to-r from-primary-50 to-cyan-50 border-primary-200">
            <Card.Content className="py-3 sm:py-4">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                <div>
                  <h5 className="font-semibold text-neutral-900 text-sm sm:text-base">Family Information</h5>
      ...
      <form onSubmit={handleSubmit}>
        ...
        >
          <Card className="mb-4 sm:mb-6">
            <Card.Header className="bg-primary-600 text-white">
              <Card.Title className="text-base sm:text-lg">Personal Details</Card.Title>
            </Card.Header>
            <Card.Content className="pt-4 sm:pt-6">
        ...
        >
          <Card className="mb-4 sm:mb-6">
            <Card.Header className="bg-primary-600 text-white">
              <Card.Title className="text-base sm:text-lg">Residence Details</Card.Title>
            </Card.Header>
            <Card.Content className="pt-4 sm:pt-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                {/* Panchayath Name */}
            ...
            {/* Form Actions */}
            <Card.Footer className="flex flex-col sm:flex-row items-center justify-end gap-2 sm:gap-3">
              <Button
                type="button"
                variant="outline"
              ...
              <Button
                ...
                variant="primary"
                loading={loading}
                leftIcon={<CheckIcon className="h-4 w-4 sm:h-5 sm:w-5" />}
                className="w-full sm:w-auto text-sm"
              >
