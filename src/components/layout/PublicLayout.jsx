        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2 max-w-full">
              <h3 className="text-xl sm:text-2xl font-bold mb-4 wrap-break-words">
                Kalloor Masjid Jama-ath
              </h3>
              <p className="text-sm sm:text-base text-white/70 leading-relaxed mb-4 wrap-break-words">
                Building a stronger community through faith, unity, and digital
                innovation.
              </p>
            </div>
            <div className="max-w-full">
              <h4 className="font-semibold mb-4 text-[#41A4A7] text-sm sm:text-base">
                Quick Links
              </h4>
              <div className="space-y-2">
                <Link
                  to="/"
                  className="block text-sm sm:text-base text-white/70 hover:text-[#41A4A7] transition-colors"
                >
                  Home
                </Link>
                <Link
                ...
                <div className="flex items-start gap-2 min-w-0">
                  ...
                  <div className="flex flex-col min-w-0">
                    <span className="text-xs sm:text-sm break-all">
                      kmjsecretary@kmjinfo.com
                    </span>
                    <span className="text-xs sm:text-sm break-all">
                      kalloormuslimjamath@gmail.com
                    </span>
                  </div>
                </div>
              </div>
